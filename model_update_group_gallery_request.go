...
// UpdateGroupGalleryRequest struct for UpdateGroupGalleryRequest
...
type NullableUpdateGroupGalleryRequest struct {
	value *UpdateGroupGalleryRequest
	isSet bool
}

func (v NullableUpdateGroupGalleryRequest) Get() *UpdateGroupGalleryRequest {
	return v.value
}

func (v *NullableUpdateGroupGalleryRequest) Set(val *UpdateGroupGalleryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateGroupGalleryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateGroupGalleryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateGroupGalleryRequest(val *UpdateGroupGalleryRequest) *NullableUpdateGroupGalleryRequest {
	return &NullableUpdateGroupGalleryRequest{value: val, isSet: true}
}

func (v NullableUpdateGroupGalleryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateGroupGalleryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
