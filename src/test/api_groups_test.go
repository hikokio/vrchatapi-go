...
func Test_vrchatapi_GroupsApiService(t *testing.T) {
    ...
    t.Run("Test GroupsApiService CancelGroupRequest", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.GroupsApi.CancelGroupRequest(context.Background(), groupId).Execute()
    ...
    t.Run("Test GroupsApiService CreateGroupInvite", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.GroupsApi.CreateGroupInvite(context.Background(), groupId).Execute()
    ...
    t.Run("Test GroupsApiService DeleteGroupInvite", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.GroupsApi.DeleteGroupInvite(context.Background(), groupId, userId).Execute()
    ...
    t.Run("Test GroupsApiService LeaveGroup", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.GroupsApi.LeaveGroup(context.Background(), groupId).Execute()
    ...
    t.Run("Test GroupsApiService RespondGroupJoinRequest", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.GroupsApi.RespondGroupJoinRequest(context.Background(), groupId, userId).Execute()
