...
func Test_vrchatapi_WorldsApiService(t *testing.T) {
    ...
    t.Run("Test WorldsApiService DeleteWorld", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.WorldsApi.DeleteWorld(context.Background(), worldId).Execute()
    ...
    t.Run("Test WorldsApiService PublishWorld", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.WorldsApi.PublishWorld(context.Background(), worldId).Execute()
    ...
    t.Run("Test WorldsApiService UnpublishWorld", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.WorldsApi.UnpublishWorld(context.Background(), worldId).Execute()
